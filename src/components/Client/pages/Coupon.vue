        ...
        <div class="row justify-content-start">
          <div class="col-lg-4">
            <div class="card m-4 border-0 shadow">
              <div class="card-body">
                <h4 class="card-title text-center"><i class="fas fa-toggle-on" style="color:skyblue"></i> 週年慶全館7折</h4>
                <hr />
                <p class="card-text">適用通路：網路</p>
                <p class="card-text">適用商品：架上商品</p>
                <h5 class="coupon-num-open text-center p-2">HAPPY2YEARS</h5>
                <p class="card-text text-muted">活動日期：2020/04/20 - 2020/5/19</p>
                <a
                  href="#"
                  class="btn btn-coupon btn-warning btn-block"
                  @click.prevent="cobycode"
                  data-clipboard-text="HAPPY2YEARS"
                >複製優惠序號</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="card m-4 border-0 shadow">
              <div class="card-body">
                <h4 class="card-title text-center"><i class="fas fa-toggle-on" style="color:skyblue"></i> 新會員享88折</h4>
                <hr />
                <p class="card-text">適用通路：網路</p>
          ...
          <div class="col-lg-4">
            <div class="card bg-light m-4 border-0 shadow-sm">
              <div class="card-body">
                <h4 class="card-title text-center"><i class="fas fa-toggle-off"  style="color:gray"></i> 月月滿千送百</h4>
                <hr/>
