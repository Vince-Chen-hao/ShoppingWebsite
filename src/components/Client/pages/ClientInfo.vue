        ...
        <div class="col-md-8">
          ...
          <form class="col-md-12" @submit.prevent="createOrder">
            <div class="form-group">
              ...
              />
              <span class="text-danger" v-if="errors.first('email')">{{ errors.first("email") }}                
              </span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group mb-4">
              <label for="message">留言 <span class="text-secondary">( 選填 )</span>
              </label>
              <textarea
                name="message"
                id="message"
            ...
            <div class="stepBtn d-flex my-4">
              ...
              <button
                type="submit"
                class="btn btn-outline-secondary justify-content-end"
              >
                確認訂購
