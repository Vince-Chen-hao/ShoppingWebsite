<template>
    <div>
        <loading :active.sync="isLoading" ></loading> <!-- 全域使用loading效果 -->
...
export default {
    ...
    methods:{
        ...
        openDelModal(item){ //參數在觸發model元件時已載入，至刪除動作時就無須在呼叫一次item參數
            const vm = this;
        ...
        updateProduct(){ //新增 ＆ 修改
            ...
            this.$http[httpMethod](api,{data:vm.tempProduct}).then((response) => { 
                ...
                if(response.data.success){
                    ...
                    vm.getProducts(); //若資料有做任何變更，需直接回傳至getProducts取得資料methods裡
                }else{
                    $('#productModal').modal('hide');
                    vm.getProducts();
                    console.log("新增失敗");
